...
public class TechnologyController {
    ...
    @GetMapping("/id/{id}")
    public Technology getTechnologyById(@PathVariable(value = "id") Long id) {
        return technologyService.getTechnologyById(id);
    }

    @GetMapping("/label/{label}")
    public Technology getTechnologyByLabel(@PathVariable(value = "label") String label) {
        return technologyService.getTechnologyByLabel(label);
    }

    @GetMapping("/moved/{moved}")
    public List<Technology> getTechnologiesByMovedStatus(@PathVariable(value = "moved") int moved) {
        return technologyService.getTechnologiesByMovedStatus(moved);
    }

    @GetMapping("/quadrant/{quadrant}")
    public List<Technology> getTechnologiesByQuadrant(@PathVariable(value = "quadrant") int quadrant) {
        return technologyService.getTechnologiesByQuadrant(quadrant);
    }

    @GetMapping("/ring/{ring}")
    public List<Technology> getTechnologiesByRing(@PathVariable(value = "ring") int ring) {
